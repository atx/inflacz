<template>
  <div class="fixed right-4 bottom-4 bg-white rounded-lg shadow-lg p-4 z-50 transition-all duration-300 opacity-100">
    <div class="text-center h-[88px] flex flex-col justify-center">
      <div class="text-sm text-gray-600 mb-1">Vypočtená inflace</div>
